 ...
 * @Date 2024/6/9 23:46
 */
public class DubboServiceComponent extends DefaultComponent {
    private static final Logger log = LoggerFactory.getLogger(DubboServiceComponent.class);
    ...
    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
        ...
        return new DubboServiceEndpoint(uri, this, remaining, parameters);
    }
    ...
    public DubboRegisterConfig getDubboRegisterConfig() {
